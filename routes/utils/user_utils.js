...
async function getWatchedRecipesByAmountSort(username) {
  let query = `SELECT recipe_id FROM watched WHERE user_name='${username}' ORDER BY watched_at DESC LIMIT 3`;
...
exports.getWatchedRecipesByAmountSort = getWatchedRecipesByAmountSort;
// exports.getFavoriteRecipes = getFavoriteRecipes;
